...
<div data-role="page">
	...
	<form action="addtraffic.php" method="post">
<h3>Select City</h3>		
...
<h3>Enter the Update</h3>
     <input type="text" name="details" id="text-1" value="">


      <center>  <input type="submit" class="ui-input-btn ui-btn ui-btn-a" data-enhanced="true" value="Search" ></center>
</form>
